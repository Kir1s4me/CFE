...
# __C.DATASETS.SHAPENET55.CATEGORY_FILE_PATH       = './dataset/ShapeNet55'
__C.DATASETS.SHAPENET55.N_POINTS                 = 2048
# __C.DATASETS.SHAPENET55.COMPLETE_POINTS_PATH     = './dataset/pc_7_feats/%s'
...
__C.DIR.OUT_PATH                                 = ''
__C.CONST.DEVICE                                 = '0'
# __C.CONST.WEIGHTS                                = '/ckpt-best.pth'
